  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="产品规格" prop="cpgg"></el-table-column>
        <el-table-column label="生产负责人" prop="scz"></el-table-column>
        <el-table-column label="产地" prop="chandi"></el-table-column>
        <el-table-column label="生产日期" prop="rq"></el-table-column>
        <el-table-column label="批次号" prop="pch"></el-table-column>
