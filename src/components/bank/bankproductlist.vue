...
<el-page-header @back="goback" content="产品详情页面">
</el-page-header>
    </div>
    <!-- 产品列表 -->
    ...
    <el-card class="box-card">
      ...
      <el-table
       :data="productList" style="width: 100%">
        ...
        <el-table-column prop="bzq" label="保质期（单位：天）" width="180"> </el-table-column>
...
export default {
    ...
    methods:{
        async getproductlist(){
            ...
            const{data:res} = await this.$http.post('getProductByQydm',{qydm:this.qydm,page:this.queryInfo.current_page});
            console.log(res)
