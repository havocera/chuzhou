...
<el-page-header @back="goback" content="产地信息详情页面">
</el-page-header>
    </div>
    <!-- 产品列表 -->
    ...
    <el-card class="box-card">
      ...
      <el-table
       :data="productList" style="width: 100%">
        ...
        <el-table-column prop="chandi" label="产地名称" width="140">
        </el-table-column>
...
export default {
    ...
    methods:{
        async getproductlist(){
            ...
            const{data:res} = await this.$http.post('getChandiByQydm',{qydm:this.qydm,page:this.queryInfo.current_page});
            console.log(res)
