 ...
 <van-image 
  ...
  <van-collapse-item title="生态原产地保护产品（PEOP）" name="9">
      <van-image 
          ...
          <div class="symtitle">物流商环节</div>
                 <div class="des">
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">

      <van-swipe-item v-for="(item,index) in showInfo.transport
" :key="index"> 
        <van-cell-group >
  <van-cell title="物流商" :value="item.qymc" />
  <van-cell title="运输时间" :value="item.delivery_time" />
  <van-cell title="所属批次" :value="item.pch" />
  <van-cell title="物流单号" :value="item.courier_number" />
  <van-cell title="发货地" :value="item.ship_address" />
</van-cell-group>
  </van-swipe-item>
</van-swipe>

          </div>
          <div class="symtitle">零售商环节</div>
                 <div class="des">
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">

      <van-swipe-item v-for="(item,index) in showInfo.retail" :key="index"> 
        <van-cell-group >
  <van-cell title="零售商" :value="item.qymc" />
  <van-cell title="零售时间" :value="item.creation_time" />
  <van-cell title="所属批次" :value="item.pch" />
