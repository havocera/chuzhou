...
var router = new VueRouter({
  ...
  routes: [
    ...
    {
      path: '/transportBaseInfo', redirect: '/transportqyInfo'
    },
    {
          ...
          children: [
            ...
            },
            {
              ...
              component:()=>import('../components/lsssystem/lssList')
               ...
               //  物流商
               {
                path: '/transportBaseInfo',
                name: 'transportBaseInfo',
                component: ()=>import('../components/transportsystem/transportBaseInfo'),
                children: [
                  {
                    path: '/transportqyInfo',
                    component: ()=>import('../components/transportsystem/transportqyInfo')
                  },
                  {
                    path:'/transportList',
                    component:()=>import('../components/transportsystem/transportList')
                  }
                ]
              },
